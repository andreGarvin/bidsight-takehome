import React, { forwardRef, ButtonHTMLAttributes, PropsWithChildren, Ref } from "react";
...
const Button: React.FC<ButtonProps> = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
  ...
  const buttonLeftIcon = leftIcon ? <Icon className="mr-2" as={leftIcon} /> : null;
  const buttonRightIcon = rightIcon ? (
    <Icon className="ml-2" as={rightIcon} />
  ) : null;
